...
class SDKServer {
  ...
  constructor(client?: AxiosInstance) {
    const oauthClient =
      client ?? (ENV.oauthConfigured ? createOAuthHttpClient() : null);
    this.client = oauthClient;
    this.oauthService = oauthClient ? new OAuthService(oauthClient) : null;
  }

  private requireOAuthService() {
  ...
  async getUserInfoWithJwt(
    ...
    const { data } =
      await this.requireOAuthClient().post<GetUserInfoWithJwtResponse>(
